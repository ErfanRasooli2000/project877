...
return [
    ...
    */
    ...
    "users_role_limitation" => "کاربران :wrong_users نمیتوانند در نقش :role فعالیت داشته باشند.",

    "contract_should_have_link_or_id" => "پروفایل باید لینک یا آیدی داشته باشد.",
];
