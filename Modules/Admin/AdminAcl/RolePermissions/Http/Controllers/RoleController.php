...
namespace Modules\Admin\AdminAcl\RolePermissions\Http\Controllers;

use App\Http\Controllers\Controller;
use App\Http\Requests\CreateRoleRequest;
use App\Http\Requests\updateRoleRequest;
use Modules\Admin\AdminAcl\RolePermissions\Http\Resources\PermissionResource;
use Modules\Admin\AdminAcl\RolePermissions\Http\Resources\RoleListResource;
use Modules\Admin\AdminAcl\RolePermissions\Http\Resources\RoleResource;
use Modules\Admin\AdminAcl\RolePermissions\Services\RolePermissionService;
...
class RoleController extends Controller
{
     ...
     *
     * @OA\Get(
     *     path="/api/v1/admin/role-permissions/index",
     *     tags={"Admin - RolePermissions"},
     ...
     *
     * @OA\Post(
     *     path="/api/v1/admin/role-permissions/create",
     *     tags={"Admin - RolePermissions"},
     ...
     *
     * @OA\Get(
     *     path="/api/v1/admin/role-permissions/show/{id}",
     *     tags={"Admin - RolePermissions"},
     ...
     *
     * @OA\Put(
     *     path="/api/v1/admin/role-permissions/update/{id}",
     *     tags={"Admin - RolePermissions"},
     ...
     *
     * @OA\Get(
     *     path="/api/v1/admin/role-permissions/permissions",
     *     tags={"Admin - RolePermissions"},
